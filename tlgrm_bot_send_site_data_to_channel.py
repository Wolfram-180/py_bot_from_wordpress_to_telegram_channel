...
Purpose of that bot: receive links to other sites, get data from them and send data to Telegram channel

'''

logging.basicConfig(filename='botlog_site_data.log', encoding='utf-8', level=logging.INFO)
